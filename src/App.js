...
function App() {
  return (
    <div className="App p-8 relative max-w-screen-xl xs:p-24">
      ...
      <div className="aboutMe mt-20 flex gap-32">
      ...
      <div className="education mt-12 flex gap-32">
        <p className="text-black flex-shrink-0">
          Education 
        </p>
        <p className="">
      ...
      <div className="stack mt-12 flex gap-32">
        <p className="text-black flex-shrink-0">
          Stack 
        </p>
        <p className="">
