      ...
      <div className="container mx-auto max-w-full flex flex-col items-center justify-center">
        ...
        <div className="max-w-3xl mx-auto bg-opacity-80 bg-blue-950 p-6 rounded-lg shadow-lg mt-8">
          <p className="text-lg sm:text-xl text-blue-100">
            A passionate software engineer born and raised in Houston, recent graduate from the 
            University of Houston. My interests primarily lie in back-end development, however, 
        ...
        <button className="shadow bg-blue-600 text-blue-100 font-bold py-2 px-4 rounded mt-8 hover:bg-blue-300">
